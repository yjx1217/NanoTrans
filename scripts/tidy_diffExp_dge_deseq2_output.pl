...
##############################################################
#  script: tidy_diffExp_dge_deseq2_output.pl
#  author: Jia-Xing Yue (GitHub ID: yjx1217)
#  last edited: 2022.10.30
#  description: tidy up flair's diffExp dge deseq2 output file
#  example: perl tidy_diffExp_dge_deseq2_output.pl -sample_table Master_Sample_Table.txt -i input.txt(.gz) -o output.txt(.gz) -m count_matrix.tsv  -x transcript2gene_map
##############################################################
