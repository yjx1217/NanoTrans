...
########################
dorado_run_device="cpu" # The running device of basecalling: "cuda:0,...,N", "cuda:all", "cpu". Default = "cpu".
...
decode_models_name="rna002_70bps_hac@v3" # The RNA model name used to basecalling. For more details, please to see: https://github.com/nanoporetech/dorado?tab=readme-ov-file#rna-models. Default = "rna002_70bps_hac@v3".
...
demultiplexing_threads=8 # The number of threads to use for demultiplexing. Default = "8".
...
then
    ...
    $dorado download --model ${decode_models_name}
    $dorado basecaller \
